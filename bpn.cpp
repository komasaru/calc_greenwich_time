 ...
 * @brief     Bias（バイアス） 適用
 *
 * @param[in] 適用前直交座標(Position)
 * @return    適用後直交座標(Position)
 */
Position Bpn::apply_bias(Position pos_src) {
  Position pos_dst;  // x, y, z
 ...
 * @return    適用後直交座標(Position)
 */
Position Bpn::apply_bias_prec(Position pos_src) {
  Position pos_dst;  // x, y, z
 ...
 * @return    適用後直交座標(Position)
 */
Position Bpn::apply_bias_prec_nut(Position pos_src) {
  Position pos_dst;  // x, y, z
 ...
 * @return    適用後直交座標(Position)
 */
Position Bpn::apply_prec(Position pos_src) {
  Position pos_dst;  // x, y, z
 ...
 * @return    適用後直交座標(Position)
 */
Position Bpn::apply_prec_nut(Position pos_src) {
  Position pos_dst;  // x, y, z
 ...
 * @return    適用後直交座標(Position)
 */
Position Bpn::apply_nut(Position pos_src) {
  Position pos_dst;  // x, y, z
